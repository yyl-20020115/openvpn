...
static inline int openvpn_gettimeofday(struct timeval *tv, void *tz)
{
...
static inline time_t openvpn_time(time_t *t)
{
    update_time();
    if (t)
    {
...
static inline bool tv_defined(const struct timeval *tv)
{
    return tv->tv_sec > 0 && tv->tv_usec > 0;
}

/* return tv1 - tv2 in usec, constrained by max_seconds */
static inline int tv_subtract(const struct timeval *tv1, const struct timeval *tv2, const unsigned int max_seconds)
{
...
static inline bool tv_lt(const struct timeval *t1, const struct timeval *t2)
{
 ...
 */
static inline bool tv_within_sigma(const struct timeval *t1, const struct timeval *t2, unsigned int sigma)
{
 ...
 * called again.
 */
static inline void interval_earliest_wakeup(interval_t *wakeup, time_t at, time_t current)
{
    if (at > current)
    {
